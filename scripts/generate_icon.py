#!/usr/bin/env python3
"""Build BrightPasses's launcher mark.
...
MARK = [
    ('M25,36 H83 A5,5 0 0 1 88,41 V48 A6,6 0 0 0 88,60 V67 A5,5 0 0 1 83,72 H25 A5,5 0 0 1 20,67 V60 A6,6 0 0 0 20,48 V41 A5,5 0 0 1 25,36 Z', 5, False),
    ('M64,42 V47', 4, False),
    ('M64,51 V57', 4, False),
    ('M64,61 V66', 4, False),
    ('M29,48 H55', 4, False),
...
<!--
  BrightPasses launcher mark. One of the unified Bright* set: 108 canvas, 18..90
